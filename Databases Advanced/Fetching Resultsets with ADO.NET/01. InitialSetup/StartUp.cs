...
namespace _01.InitialSetup
{
    class Program
    {
        ...
        {
            SqlConnection connection = new SqlConnection(Configuration.ConnectionStringInitial);
            ...
            using (connection)
            {
                ...
                ExecuteCommand(createTableCountries, connection);
                ExecuteCommand(createTableTowns, connection);
                ExecuteCommand(createTableMinions, connection);
                ExecuteCommand(createTableEvilnessFactors, connection);
                ExecuteCommand(createTableVillains, connection);
                ExecuteCommand(createTableMinionsVillains, connection);
                ...
                ExecuteCommand(insertCountries, connection);
                ExecuteCommand(insertTowns, connection);
                ExecuteCommand(insertMinions, connection);
                ExecuteCommand(insertEvilnessFactors, connection);
                ExecuteCommand(insertVillains, connection);
                ExecuteCommand(insertMinionsVillains, connection);
